...
namespace BrawlTCG_alpha.Logic
{
    internal class CardCatalogue
    {
        ...
        public static LegendCard BriarRose = new LegendCard("Briar Rose", 2, "Legend", Elements.Nature, Properties.Resources.BriarRose, 6, 7, 4, 5, Weapons.Spear, Weapons.Greatsword, attack1: AttackCatalogue.Spear_Stab.Clone()); // speed stance
