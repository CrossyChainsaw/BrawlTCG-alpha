...
namespace BrawlTCG_alpha.Logic
{
    public class CardCatalogue
    {
        public static Dictionary<int, Card> CardDictionary = new Dictionary<int, Card>()
        {
            ...
            { 20001, new WeaponCard(id: 20001, "Winter Daggers", 1, Elements.Arctic, Images.Winter_Daggers, Weapons.Katars) }, // New Card
            // Lance
            ...
            { 23004, new WeaponCard(id: 23004, "Amethyst Scythe", 1, Elements.Magic, Images.Constellation_Carver, Weapons.Scythe) }, // New Card
            // Spear
            ...
            { 25002, new WeaponCard(id: 25002, "Frozen Edge", 1, Elements.Arctic, Images.FrozenEdge, Weapons.Sword) }, // New Card
            { 25003, new WeaponCard(id: 25003, "Ancestor's Flame", 1, Elements.Fire, Images.Ancestors_Flame, Weapons.Sword) }, // New Card




            { 500, new BattleCard(id: 500, "Bouncy Bomb", 2, "When Played: Deals direct damage 7", Elements.Shadow, Images.BouncyBomb, oneTimeUse: true, stackable: false, friendlyFire: false, whenPlayedEffect: ec.BattleCardDirectDamageWhenPlayed, damage: 7) },
            ...
            { 502, new BattleCard(id: 502, "Snowball", 1, "When Played: Deals direct damage 3", Elements.Arctic, Images.Snowball, true, false, false, whenPlayedEffect: ec.BattleCardDirectDamageWhenPlayed, damage: 3) },
            { 503, new BattleCard(id: 503, "Super Saiyan", 5, "When Played: Boosts legend stats +5/+5", Elements.Wild, Images.SuperSaiyan, false, true, true, whenPlayedEffect: ec.BoostHealthAndPower, powerModifier: 5, healthModifier: 5) },
            ...
            { 506, new BattleCard(id: 506, "Chest", 1, "When Played: Legend opens the chest, obtain 3 random cards", Elements.Magic, Images.CardChest, true, false, true, whenPlayedEffect: ec.CardChest) },
            ...
            { 512, new BattleCard(id: 512, "Cosmic Chest", 3, "When Played: Legend opens the chest, obtain three random Cosmic cards", Elements.Cosmic, Images.Cosmic_Chest, true, false, true, whenPlayedEffect: ec.CosmicChest) },
            { 513, new BattleCard(id: 513, "Wild Chest", 3, "When Played: Legend opens the chest, obtain three random Wild cards", Elements.Wild, Images.Wild_Chest, true, false, true, whenPlayedEffect: ec.WildChest) },
            { 514, new BattleCard(id: 514, "Dragon's Chest", 3, "When Played: Legend opens the chest, obtain three random Fire cards", Elements.Fire, Images.Dragon_Chest, true, false, true, whenPlayedEffect: ec.DragonChest) },
            { 515, new BattleCard(id: 515, "Sunken Chest", 3, "When Played: Legend opens the chest, obtain three random Arctic cards", Elements.Arctic, Images.Sunken_Chest, true, false, true, whenPlayedEffect: ec.SunkenChest) },
