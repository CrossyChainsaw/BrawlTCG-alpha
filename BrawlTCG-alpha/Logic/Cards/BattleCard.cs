...
namespace BrawlTCG_alpha.Logic.Cards
{
    public class BattleCard : Card
    {
        ...
        public BattleCard(int id, string name, int cost, string description, Elements element, Image image, bool oneTimeUse, bool stackable, bool friendlyFire, Effect? startTurnEffect = null, Action<object>? endTurnEffect = null, Effect? whenPlayedEffect = null, int damage = 0, int powerModifier = 0, int healthModifier = 0) : base(id, name, cost, element, image, startTurnEffect, endTurnEffect, whenPlayedEffect)
        {
